...
module LanguageTag.Internal.BCP47.LegacyTag.Redundant where

import Prelude hiding (LT, GT)
import Control.DeepSeq (NFData(..), rwhnf)
import Data.Hashable (Hashable(..), hashUsing)

-- | The BCP47 redundant tags as of 2025-01-21. The names of redundant constructors are derived from the corresponding tag by converting the subtags to title case and then removing the intermediate dashes.
data Redundant
