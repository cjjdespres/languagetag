...
scriptDetails = V.fromList
  ...
  ,(Subtag 14385428702328520708, ScriptRecord ("Chisoi" :| []) NotDeprecated)
  ...
  ,(Subtag 14954086083170664452, ScriptRecord ("Garay" :| []) NotDeprecated)
  ...
  ,(Subtag 14976542989692698628, ScriptRecord ("Gurung Khema" :| []) NotDeprecated)
  ...
  ,(Subtag 15530591365695012868, ScriptRecord ("Kawi" :| []) NotDeprecated)
  ...
  ,(Subtag 15549538150064848900, ScriptRecord ("Kirat Rai" :| []) NotDeprecated)
  ...
  ,(Subtag 15962796467312132100, ScriptRecord ("Nag Mundari" :| []) NotDeprecated)
  ...
  ,(Subtag 16121495715057762308, ScriptRecord ("Ol Onal" :| []) NotDeprecated)
  ...
  ,(Subtag 16692353699703422980, ScriptRecord ("Sidetic" :| []) NotDeprecated)
  ...
  ,(Subtag 16705952528235233284, ScriptRecord ("Sunuwar" :| []) NotDeprecated)
  ...
  ,(Subtag 16827646062880620548, ScriptRecord ("Tai Yo" :| []) NotDeprecated)
  ...
  ,(Subtag 16843224149781381124, ScriptRecord ("Todhri" :| []) NotDeprecated)
  ,(Subtag 16843294587245035524, ScriptRecord ("Tolong Siki" :| []) NotDeprecated)
  ,(Subtag 16843364681111306244, ScriptRecord ("Toto" :| []) NotDeprecated)
  ,(Subtag 16850119530796548100, ScriptRecord ("Tulu-Tigalari" :| []) NotDeprecated)
